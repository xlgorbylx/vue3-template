...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (lazyImages.length > 0) {
    // コールバック関数を登録して、IntersectionObserverのオブジェクトを生成
    let lazyImageObserver = new IntersectionObserver(function (entries, observer) {
      ...
      entries.forEach(function (entry) {
        ...
        if (entry.isIntersecting) {
          ...
          if (lazyImage.dataset && lazyImage.dataset.hasOwnProperty('src')) {
            // data-src属性値があれば、src属性にコピー
  ...
  function i(e, n) {
    if ('object' == typeof e) for (var A in e) f(e, A) && i(A, e[A])
      ...
      ;(n = 'function' == typeof n ? n() : n),
        1 == t.length
          ? (Modernizr[t[0]] = n)
          : (!Modernizr[t[0]] || Modernizr[t[0]] instanceof Boolean || (Modernizr[t[0]] = new Boolean(Modernizr[t[0]])),
            (Modernizr[t[0]][t[1]] = n)),
        o([(n && 0 != n ? '' : 'no-') + t.join('-')]),
